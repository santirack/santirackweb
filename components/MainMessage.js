...
function MainMessage(props) {
  return (
    <p className={classes.fontMainMessage} hidden={props.hidden}>
      ...
      took a course in Udemy from zero to expert in JavaScript and I really
      liked the language so I'm currently challenging myself to learn React.js,
      im now studying again but this time React.js wich I find much more fun to
      program with than just pure JavaScript! I'm also constantly learning CSS
      because I like to add some style to the apps I make!
    </p>
  );
}
